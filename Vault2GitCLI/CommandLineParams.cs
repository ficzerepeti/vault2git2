...
namespace Vault2Git.CLI
{
    public class Params
    {
        ...
        public override string ToString() => $"{nameof(Limit)}: {Limit}, {nameof(SkipEmptyCommits)}: {SkipEmptyCommits}, {nameof(IgnoreLabels)}: {IgnoreLabels}, {nameof(Verbose)}: {Verbose}, {nameof(ForceFullFolderGet)}: {ForceFullFolderGet}, {nameof(RunContinuously)}: {RunContinuously}, {nameof(DoGitPushOrigin)}: {DoGitPushOrigin}, {nameof(BeginDate)}: {BeginDate}, {nameof(Branches)}: {Branches}, {nameof(Directories)}: {Directories}, {nameof(VaultServer)}: {VaultServer}, {nameof(VaultUser)}: {VaultUser}, {nameof(VaultPassword)}: {VaultPassword}, {nameof(VaultRepo)}: {VaultRepo}, {nameof(GitDomainName)}: {GitDomainName}, {nameof(WorkingFolder)}: {WorkingFolder}, {nameof(GitCmd)}: {GitCmd}, {nameof(Paths)}: {Paths}";
